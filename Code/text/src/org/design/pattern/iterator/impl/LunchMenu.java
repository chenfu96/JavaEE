...
public class LunchMenu implements Menu {
    ...
    private void initMenu() {
        menuItems[0] = new MenuItem("ºìÉÕÈâ", 10.0);
        menuItems[1] = new MenuItem("´øÓã", 12.0);
        menuItems[2] = new MenuItem("ÍÁ¶¹Ë¿", 6.0);
        menuItems[3] = new MenuItem("¼¦ÍÈ", 9.0);
        menuItems[4] = new MenuItem("ºìÉÕÓã", 10.0);
    }
